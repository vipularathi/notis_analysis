...
from common import today,yesterday,write_notis_postgredb, write_notis_data, bse_dir, get_date_from_non_jiffy,read_file, read_data_db, logger
...
class BSEUtility:
    ...
    @staticmethod
    def get_bse_trade_data():
        df_bse = read_data_db(for_table='TradeHist')
        df_bse = df_bse.query("mnmTransactionType != 'L'")
        if df_bse.empty:
